...
class CreateDatingUserTests(TestCase):
	...
	def test_create_user(self):
		...
		user = user_model.objects.create_user(email='simpleuser@user.com', password='foo12345')
	...
	def test_create_superuser(self):
		...
		try:
			self.assertIsNone(admin_user.username)      # username is None in DatingUser model
